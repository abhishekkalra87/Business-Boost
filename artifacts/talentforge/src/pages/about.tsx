          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card p-8 md:p-12 rounded-2xl shadow-sm border border-border">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                "I founded Nexzenta HR Solutions with a singular premise: specialized industries require specialized hiring. By bringing together AI-driven sourcing and veteran HR intuition, we've created a framework that guarantees not just a candidate, but the right partner for your growth."
              </p>
